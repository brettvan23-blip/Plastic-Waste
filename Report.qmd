...
```{r}
#| eval: false
api_key <- "K1gULUuUnX8mxdZGU8RME1aTSdiJCp0ei44xagcQ"
...
### Description:
I wanted to see whether plastic waste per volunteer was related to average PM2.5 concentration across countries. It helps show whether countries with a greater plastic burden relative to cleanup effort also have worse air quality.
